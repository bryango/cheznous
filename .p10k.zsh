# Generated by Powerlevel10k configuration wizard on 2024-01-14 at 11:03 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ## USERMOD: moved all to the left prompt
  )
  ...
  ## USERMOD: no space at end of right prompt
  ## https://github.com/romkatv/powerlevel10k/issues/2506#issuecomment-1849472700
  ...
  # Red (196) prompt symbol if the last command failed. ## USERMOD: don't!
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=76 ## USERMOD
  ...
  function my_git_formatter() {
    ...
    local       meta='%7F' # white foreground ## USERMOD
    local      clean='%B%7F' # bold, white foreground ## USERMOD
    local   modified='%7F' # white foreground ## USERMOD
    local  untracked='%7F' # white foreground ## USERMOD
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=white
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='%B%7F' ## USERMOD
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_VISUAL_IDENTIFIER_EXPANSION='' ## USERMOD
  # Custom prefix.
  ...
  #[ nix_shell: nix shell (https://nixos.org/nixos/nix-pills/developing-with-nix-shell.html) ]##
  # Nix shell color.
  typeset -g POWERLEVEL9K_NIX_SHELL_FOREGROUND=white ## USERMOD
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION='' ## USERMOD
  # Custom prefix.
